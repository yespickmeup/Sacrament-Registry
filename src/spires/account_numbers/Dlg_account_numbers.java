 ...
 */
package spires.account_numbers;
 ...
 * @author Guinness
 */
public class Dlg_account_numbers extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_account_numbers(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_account_numbers(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_account_numbers myRef;

    private void setThisRef(Dlg_account_numbers myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_account_numbers> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_account_numbers create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_account_numbers create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_account_numbers dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_account_numbers((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_account_numbers((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_account_numbers dialog = Dlg_account_numbers.create(new javax.swing.JFrame(), true);
...
//                btn_0.doClick();
    ...
    public static void init_tbl_official_schedule_types(JTable tbl_official_schedule_types) {
        ...
        int[] tbl_widths_official_schedule_types = {100, 150, 30, 30, 0, 0, 0};
    ...
    public static void loadData_official_schedule_types(List<Account_numbers.to_account_numbers> acc) {
    ...
    public static class Tblofficial_schedule_typesModel extends AbstractTableAdapter {
        ...
        public static String[] COLUMNS = {
            "Account No", "Description", "", "", "updated_by", "status", "schedule_type"
        };
        ...
        public Object getValueAt(int row, int col) {
            Account_numbers.to_account_numbers tt = (Account_numbers.to_account_numbers) getRow(row);
            switch (col) {
                case 0:
    ...
    private void ret_official_schedule_types() {
        ...
        List<Account_numbers.to_account_numbers> datas = Account_numbers.ret_data(where);
    ...
    private void save_official_schedule_types() {
        ...
        if (row < 0) {
            ...
            int status = 1;
            Account_numbers.to_account_numbers account = new Account_numbers.to_account_numbers(id, description, account_no, status);
            Account_numbers.add_data(account);
            Alert.set(1, account_no);
            ret_official_schedule_types();
        } else {
            Account_numbers.to_account_numbers to = (Account_numbers.to_account_numbers) tbl_official_schedule_types_ALM.get(row);
            int id = to.id;
            String description = jTextField2.getText();
            String account_no = jTextField1.getText();
            int status = 1;
            Account_numbers.to_account_numbers account = new Account_numbers.to_account_numbers(id, description, account_no, status);
            Account_numbers.update_data(account);
            Alert.set(2, account_no);
            ret_official_schedule_types();
        }
        clear_official_schedule_types();
    }
    ...
    private void select_official_schedule_types() {
        ...
        if (col == 2) {
            Account_numbers.to_account_numbers to = (Account_numbers.to_account_numbers) tbl_official_schedule_types_ALM.get(row);
            jTextField1.setText(to.account_no);
