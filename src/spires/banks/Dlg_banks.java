...
//                btn_0.doClick();
    ...
    public static void loadData_official_schedule_types(List<Banks.to_banks> acc) {
    ...
    private void save_official_schedule_types() {
        ...
        if (row < 0) {
            ...
            Banks.to_banks bank1 = new Banks.to_banks(id, created_at, updated_at, created_by, updated_by, status, bank);
            Banks.add_data(bank1);
            ret_official_schedule_types();
            Alert.set(1, "");

        } else {
            Banks.to_banks to = (Banks.to_banks) tbl_official_schedule_types_ALM.get(row);
            int id = to.id;
    ...
    private void select_official_schedule_types() {
        ...
        final Banks.to_banks to = (Banks.to_banks) tbl_official_schedule_types_ALM.get(row);
        if (col == 1) {
            jTextField1.setText(to.bank);
        }
        if (col == 2) {
