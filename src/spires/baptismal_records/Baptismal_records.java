 ...
 * @author Guinness
 */
public class Baptismal_records {
    ...
    public static void add_parishioners_1(Srpt_print_baptism.field to_parishioners_1) {
        try {
            ...
            stmt.execute();
            Lg.s(Baptismal_records.class, "Successfully Added");
    ...
    public static void delete_parishioners_1(String id) {
        try {
            ...
            PreparedStatement stmt = conn.prepareStatement(s0);
            stmt.execute();
            Lg.s(Baptismal_records.class, "Successfully Deleted");
        } catch (SQLException e) {
            throw new RuntimeException(e);
        } finally {
            MyConnection.close();
    ...
    public static void delete_data(Srpt_print_baptism.field to_parishioners_1) {
        try {
            Connection conn = MyConnection.connect();
            String s0 = "delete from parishioners_1  "
                    + " where id='" + to_parishioners_1.getId() + "' "
                    + " ";
