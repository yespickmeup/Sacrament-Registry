...
import spires.encode_bacong.Bacong_encoded_confirmation;
 ...
 * @author Guinness
 */
public class Dlg_confirmation_encoding extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_confirmation_encoding(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_confirmation_encoding(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    public Dlg_confirmation_encoding() {
        super();
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_confirmation_encoding myRef;

    private void setThisRef(Dlg_confirmation_encoding myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_confirmation_encoding> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_confirmation_encoding create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_confirmation_encoding create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_confirmation_encoding dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_confirmation_encoding((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_confirmation_encoding((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_confirmation_encoding dialog = Dlg_confirmation_encoding.create(new javax.swing.JFrame(), true);
...
//                btn_0.doClick();
    ...
    public static void loadData_expenses(List<Bacong_encoded_confirmation.encoded> acc) {
    ...
    public static class TblexpensesModel extends AbstractTableAdapter {
        ...
        public static String[] COLUMNS = {
            "Page No", "Index No", "First Name", "MI", "Last Name", "Father", "Mother", "Confirmed", "Birth", "Place of Birth", "Sponsors", "Notes", "Parish Priest", "Minister"
...
//              "Page No", "Index No", "fname", "mi", "lname", "father", "mother", "date_of_baptism", "date_of_birth", "place_of_birth", "sponsor", "notes", "parish_priest", "minister"
            ...
            Bacong_encoded_confirmation.encoded tt = (Bacong_encoded_confirmation.encoded) getRow(row);
            switch (col) {
                case 0:
                    return " " + tt.page_no;
                case 1:
...
//</editor-fold> 
    ...
    private void select_excel() {
        ...
        List<Bacong_encoded_confirmation.encoded> datas = Bacong_encoded_confirmation.showExcelData(sheetData, path);
    ...
    private void save_encoded() {
        final List<Bacong_encoded_confirmation.encoded> datas = tbl_expenses_ALM;
        if (datas.isEmpty()) {
            Alert.set(0, "Empty record!");
            return;
        }
        Window p = (Window) this;
        Dlg_confirmation_confirm_on_save nd = Dlg_confirmation_confirm_on_save.create(p, true);
        nd.setTitle("");

        nd.setCallback(new Dlg_confirmation_confirm_on_save.Callback() {

            @Override
            public void ok(CloseDialog closeDialog, final Dlg_confirmation_confirm_on_save.OutputData data) {
                closeDialog.ok();
                ...
                Thread t = new Thread(new Runnable() {
                    ...
                    @Override
                    public void run() {
                        Bacong_encoded_confirmation.add_parishioners_1(datas, data.book_no, data.delete_existing_record);
                        tbl_expenses_ALM.clear();
                        Alert.set(1, "");
                        jTextField1.setText("");
