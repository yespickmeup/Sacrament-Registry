...
import spires.expenses.S1_expenses.to_expenses;
import SR.main.Main;
    ...
    private void initComponents() {
        ...
        jXPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jXPanel1Layout.createSequentialGroup()
                ...
                .addComponent(tf_search, javax.swing.GroupLayout.PREFERRED_SIZE, 238, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        jXPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jXPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(tf_expense_name, javax.swing.GroupLayout.PREFERRED_SIZE, 455, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
...
//                btn_0.doClick();
    ...
    private void data_cols() {
        ...
        String where = " where expense_name like '%" + search + "%'";
        loadData_expenses(S1_expenses.ret_data(where));
    }
