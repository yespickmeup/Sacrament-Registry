 ...
 * @author Guinness
 */
public class Dlg_funerall_books extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_funerall_books(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_funerall_books(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_funerall_books myRef;

    private void setThisRef(Dlg_funerall_books myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_funerall_books> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_funerall_books create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_funerall_books create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_funerall_books dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_funerall_books((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_funerall_books((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_funerall_books dialog = Dlg_funerall_books.create(new javax.swing.JFrame(), true);
...
//        tbl_official_schedule_types.getColumnModel().getColumn(2).setCellRenderer(new ImageRenderer1());
    ...
    private void ret_data() {
        ...
        List<Encoding_funeral2.to_encoding_funeral2> datas = Encoding_funeral2.ret_books(where);
