 ...
 * @author Guinness
 */
public class Dlg_marriage_books extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_marriage_books(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_marriage_books(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_marriage_books myRef;

    private void setThisRef(Dlg_marriage_books myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_marriage_books> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_marriage_books create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_marriage_books create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_marriage_books dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_marriage_books((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_marriage_books((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_marriage_books dialog = Dlg_marriage_books.create(new javax.swing.JFrame(), true);
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Total no. encoded:");
...
//                btn_0.doClick();
    ...
    public static void init_tbl_official_schedule_types(JTable tbl_official_schedule_types) {
        ...
        int[] tbl_widths_official_schedule_types = {100, 60, 30, 0, 0, 0, 0};
...
//        tbl_official_schedule_types.getColumnModel().getColumn(2).setCellRenderer(new ImageRenderer1());
    ...
    public static void loadData_official_schedule_types(List<Encoding_funeral2.to_encoding_funeral2> acc) {
    ...
    public static class Tblofficial_schedule_typesModel extends AbstractTableAdapter {
        ...
        public static String[] COLUMNS = {
            "Book", "Count", "", "created_by", "updated_by", "status", "schedule_type"
        };
        ...
        public Object getValueAt(int row, int col) {
            Encoding_funeral2.to_encoding_funeral2 tt = (Encoding_funeral2.to_encoding_funeral2) getRow(row);
            switch (col) {
                case 0:
                ...
                case 2:
                    return "/spires/img_functions/magnifying-glass34.png";
                case 3:
    ...
    private void ret_data() {
        ...
        List<Encoding_funeral2.to_encoding_funeral2> datas = Encoding_funeral2.ret_books_marriage(where);
        loadData_official_schedule_types(datas);
        int count=datas.size();
        int rows=0;
        for(Encoding_funeral2.to_encoding_funeral2 to:datas){
            rows+=to.id;
        }
        jLabel2.setText(FitIn.fmt_wc(count));
        jLabel4.setText(FitIn.fmt_wc(rows));
    }
}
