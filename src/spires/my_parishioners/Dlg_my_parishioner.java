 ...
 * @author Guinness
 */
public class Dlg_my_parishioner extends javax.swing.JDialog {
    ...
    public static class OutputData {
        ...
        public final My_parishioners.to_my_parishioners to;

        public OutputData(My_parishioners.to_my_parishioners to) {
            this.to = to;
        }
...
//</editor-fold>
    ...
    private Dlg_my_parishioner(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_my_parishioner(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_my_parishioner myRef;

    private void setThisRef(Dlg_my_parishioner myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_my_parishioner> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_my_parishioner create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_my_parishioner create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_my_parishioner dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_my_parishioner((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_my_parishioner((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_my_parishioner dialog = Dlg_my_parishioner.create(new javax.swing.JFrame(), true);
...
//                btn_0.doClick();
    ...
    public static void init_tbl_official_schedule_types(JTable tbl_official_schedule_types) {
        ...
        int[] tbl_widths_official_schedule_types = {100, 100, 100, 30, 30, 0, 0};
        ...
        tbl_official_schedule_types.getColumnModel().getColumn(3).setCellRenderer(new ImageRenderer1());
        tbl_official_schedule_types.getColumnModel().getColumn(4).setCellRenderer(new ImageRenderer1());
    }

    public static void loadData_official_schedule_types(List<My_parishioners.to_my_parishioners> acc) {
    ...
    public static class Tblofficial_schedule_typesModel extends AbstractTableAdapter {
        ...
        public static String[] COLUMNS = {
            "Name", "Address", "Contact No", "", "", "status", "schedule_type"
        };
        ...
        public Object getValueAt(int row, int col) {
            My_parishioners.to_my_parishioners tt = (My_parishioners.to_my_parishioners) getRow(row);
            switch (col) {
                case 0:
    ...
    private void ret_official_schedule_types() {
        ...
        List<My_parishioners.to_my_parishioners> datas = My_parishioners.ret_data(where);
    ...
    private void save_official_schedule_types() {
        ...
        if (row < 0) {
            int id = 0;
            String parishioner = jTextField1.getText();
            String contact_no = jTextField3.getText();
            String address = jTextField2.getText();
            My_parishioners.to_my_parishioners pa = new My_parishioners.to_my_parishioners(id, parishioner, contact_no, address);
            My_parishioners.add_my_parishioners(pa);
            Alert.set(1, address);
            ret_official_schedule_types();
            if (callback_tiggered == 1) {
                ok();
            }
        } else {
            My_parishioners.to_my_parishioners to = (My_parishioners.to_my_parishioners) tbl_official_schedule_types_ALM.get(row);
            int id = to.id;
            String parishioner = jTextField1.getText();
            String contact_no = jTextField3.getText();
            String address = jTextField2.getText();
            My_parishioners.to_my_parishioners pa = new My_parishioners.to_my_parishioners(id, parishioner, contact_no, address);
            My_parishioners.edit_my_parishioners(pa);
            Alert.set(2, address);
            ret_official_schedule_types();
        }
        clear_official_schedule_types();
    ...
    private void ok() {
        if (tbl_official_schedule_types_ALM.size() == 1) {
            My_parishioners.to_my_parishioners to = (My_parishioners.to_my_parishioners) tbl_official_schedule_types_ALM.get(0);
            if (callback != null) {
    ...
    private void select_official_schedule_types() {
        ...
        final My_parishioners.to_my_parishioners to = (My_parishioners.to_my_parishioners) tbl_official_schedule_types_ALM.get(row);
        if (col == 3) {
            jTextField1.setText(to.parishioner);
            jTextField2.setText(to.address);
            jTextField3.setText(to.contact_no);
        }
        if (col == 4) {
            ...
            nd.setCallback(new Dlg_confirm_action.Callback() {
                ...
                public void ok(CloseDialog closeDialog, Dlg_confirm_action.OutputData data) {
                    closeDialog.ok();
                    My_parishioners.delete_my_parishioners(to);
                    Alert.set(3, "");
                    ret_official_schedule_types();
                }
            });
