 ...
 * @author Ronald
 */
public class Dlg_printing_confirmation extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_printing_confirmation(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_printing_confirmation(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    public Dlg_printing_confirmation() {
        super();
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_printing_confirmation myRef;

    private void setThisRef(Dlg_printing_confirmation myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_printing_confirmation> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_printing_confirmation create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_printing_confirmation create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_printing_confirmation dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_printing_confirmation((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_printing_confirmation((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_printing_confirmation dialog = Dlg_printing_confirmation.create(new javax.swing.JFrame(), true);
    ...
    private void initComponents() {
                        ...
                        .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel7Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(dp_confirmation, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
        ...
        jPanel7Layout.setVerticalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGap(1, 1, 1)
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(dp_confirmation, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void tf_priestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tf_priestActionPerformed
         init_priest2(tf_priest, new JTextField());
...
//                btn_0.doClick();
    ...
    List<Srpt_print_confirmation.field> search_list = new ArrayList();
    ...
    private void init_search(final JTextField tf1) {
        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if (jCheckBox9.isSelected()) {
                    where = " where mother like '%" + tf1.getText() + "%' order by fname asc";
                }
                if (jCheckBox10.isSelected()) {
                    where = " where father like '%" + tf1.getText() + "%'";
                }
                search_list = Srpt_print_confirmation.ret_data(where);
                Object[][] obj = new Object[search_list.size()][9];
                int i = 0;
                for (Srpt_print_confirmation.field to : search_list) {
                    obj[i][0] = to.id;
                    ...
                    obj[i][7] = to.confirmation_date;
                    obj[i][8] = to.sponsors;
                    i++;
                }

                JLabel[] labels = {};
                int[] tbl_widths_customers = {60, 150, 50, 50, 100, 100, 100, 100, 300};
                Dimension d = jTextField2.getSize();
                int width = d.width;
                String[] col_names = {"Ref #", "Name", "Book #", "Page #", "Mother", "Father", "Baptism", "Confirmation", "Sponsors"};
        ...
        tr.setCallback(new TableRenderer2.Callback() {
            @Override
            public void ok(TableRenderer2.OutputData data) {
                final Srpt_print_confirmation.field to = search_list.get(data.selected_row);
    ...
    private void set_details(Srpt_print_confirmation.field to) {
        ...
        try {
            ...
            Date confirmation = DateType.slash.parse(to.confirmation_date);
            dp_baptism.setDate(baptism);
            dp_confirmation.setDate(confirmation);
    ...
    private void set_certificate(Srpt_print_confirmation.field to) {
        ...
        try {
            ...
            d3 = DateType.slash.parse(to.confirmation_date);
            d4 = DateType.slash.parse(to.date_of_birth);
        } catch (ParseException ex) {
            Logger.getLogger(Dlg_printing_confirmation.class.getName()).
                    log(Level.SEVERE, null, ex);
        }
        String date_of_confirmation = DateType.month_date.format(d3);
    ...
    private void certificate_confirmation(SRpt_confirmation to, String jrxml_name) {
        jPanel6.removeAll();
    ...
    private void update_encoded() {
        ...
        String b_day = "";
        String conf_date = DateType.sf.format(dp_confirmation.getDate());
        String gender = "";
        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    S1_encoding_confirmation.edit_encoding_confirmation2(to);
                    jProgressBar2.setString("Finished...");
                    jProgressBar2.setIndeterminate(false);
                    Alert.set(2, "");
    ...
    private void add_record() {
        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    S1_encoding_confirmation.add_encoding_confirmation2(to);
    ...
    private void delete_record() {
        final int id = FitIn.toInt(jLabel23.getText());
        jProgressBar1.setString("Loading...Please wait...");
        jProgressBar1.setIndeterminate(true);
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                S1_encoding_confirmation.delete_encoding_confirmation2("" + id);
                jProgressBar1.setString("Finished...");
                jProgressBar1.setIndeterminate(false);
                clear();
                jButton3.setEnabled(true);
    ...
    private void init_priest2(final JTextField tf1, final JTextField tf2) {
        String search = tf1.getText();
        if (search.isEmpty()) {
            tf2.setText("");
            tf_sponsors.grabFocus();
        } else {
            priest_list.clear();
            String where = "where name like '%" + search + "%' order by  designation desc";
            priest_list = Officials.retData(where);
