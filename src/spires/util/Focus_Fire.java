...
public class Focus_Fire {
    ...
    public static void onFocus_lostFocus2(final JTextArea tf) {
        tf.addFocusListener(new FocusListener() {
    ...
    public static void nextFocus(JTextField tf, final JTextArea tf2) {
        tf.addActionListener(new ActionListener() {
    ...
    public static void nextFocus(JTextField tf, final JComboBox tf2) {
        tf.addActionListener(new ActionListener() {
    ...
    public static void nextFocus(JComboBox tf, final JTextField tf2) {
        tf.addActionListener(new ActionListener() {
    ...
    public static void nextFocus(JComboBox tf, final JComboBox tf2) {
        tf.addActionListener(new ActionListener() {
