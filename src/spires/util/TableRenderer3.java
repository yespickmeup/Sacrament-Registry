 ...
 * @author Maytopacka
 */
public class TableRenderer3 {

    private static Callback callback;

    public void setCallback(Callback callback) {
        TableRenderer3.callback = callback;
    }
    ...
    public static void setModel(JTable tbl, Object[][] obj, String[] col_names, int[] tbl_widths_customers1) {
        ...
        tbl.setBackground(new java.awt.Color(247, 130, 40));
        Dimension d = tbl.getTableHeader().getPreferredSize();
        d.height = 0;
        tbl.getTableHeader().setPreferredSize(d);
    }
...
//                isEmpty()) {
        ...
        TableRenderer3.setModel(tbl, obj, col_names, tbl_widths_customers);
        ///----------------
